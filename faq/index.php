    ...
    <nav class="navbar navbar-custom" role="navigation" style="color: black">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="/../Carrent/index.php">
                   Carrent </a>
            </div>
            ...
            ?>
                ...
                <ul class="nav navbar-nav">
                    <li>
                        <a href="/../Carrent/index.php">Home</a>
                    </li>
                    <li>
                        <a href="/../Carrent/clientlogin.php">Client</a>
                    </li>
                    <li>
                        <a href="/../Carrent/customerlogin.php">Customer</a>
                    </li>
                    <li>
                        <a href="#"> FAQ </a>
                    </li>
