...
use PHPMailer\PHPMailer\Exception;
    ...
    try {
        ...
        $mail->Username = 'carrent.cars@gmail.com';  // sender gmail host              
        $mail->Password = 'Carrent.cars1'; // sender gmail host password                          
        $mail->SMTPSecure = 'tls';  // for encrypted connection                           
        $mail->Port = 587;   // port for SMTP     
    
        $mail->setFrom('carrent.cars@gmail.com', "CARRENT"); // sender's email and name
        $mail->addAddress('dev.kansara_19@sakec.ac.in', "Receiver");  // receiver's email and name
    
        $mail->Subject = 'Booking Confirmation';
        $mail->Body    = 'Congratulations ' . $customer_username .', your car ' . $car_name . ' has been successfully booked! & your booking number is ' . $id .', Lisence Plate Number: '. $car_nameplate . ' In case of any problem contact with client (owner of vehicle) on contact number: ' . $client_phone . '';
...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: black">
    ...
    <h2 class="text-center"> Thank you for visiting Carrent! We wish you have a safe ride. </h2>
